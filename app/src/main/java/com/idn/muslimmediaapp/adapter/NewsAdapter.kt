...
class NewsAdapter : RecyclerView.Adapter<NewsAdapter.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val dateArray = date?.split("-")?.toTypedArray()// to convert the string type to array structuer, e.g: "2023-12-10" --> ["2023", "12", "10"]
        ...
        //for print log info on the logcat, espicially for date and time
